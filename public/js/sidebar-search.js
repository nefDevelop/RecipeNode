document.addEventListener("DOMContentLoaded", () => {
  ...
  const generateRecipeCardHtml = (recipe) => {
    ...
    if (displaySettings.name) {
      cardContentHtml += `
          <div class="flex items-center gap-2 mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 dark:text-gray-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
            </svg>
            <h3
              class="font-semibold text-lg text-gray-800 dark:text-gray-200 group-hover:text-green-600 truncate min-w-0"
              title="${recipe.name}"
            >
              ${recipe.name}
            </h3>
    ...
    if (displaySettings.mealType && recipe.meal_type) {
      cardContentHtml += `
          <div class="meta-item" title="Tipo de comida">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    if (displaySettings.rating && recipe.rating) {
      cardContentHtml += `
          <div class="meta-item" title="Puntuación">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    if (displaySettings.views && recipe.views !== undefined) {
      cardContentHtml += `
          <div class="meta-item" title="Vistas">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    if (displaySettings.description && recipe.description) {
      cardContentHtml += `
          <div class="meta-item col-span-full" title="Descripción">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h7" />
            </svg>
            <span class="truncate">${recipe.description}</span>
          </div>
        `;
    }
